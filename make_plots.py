...
def plot_by_gene_and_gender_and_tissue(gencode_id, gene_name, tissue):
    ...
    fig.update_layout(violinmode='group', template="plotly_dark",  yaxis_title="TPM", title= "Violin plot of Gene {}({}) and Tissue {} divided by gender".format(gencode_id, gene_name, tissue))
    return fig
...
def plot_by_gene_and_gender(gencode_id, gene_name):
    ...
    fig.update_xaxes(type='category')
    fig.update_layout(violinmode='group', template="plotly_dark", yaxis_title="TPM", title= "Violin plot of Gene {}({}) divided by Gender".format(gencode_id, gene_name), autosize=False, width=1000, height=1500, xaxis=dict(rangeslider=dict(
                     visible=True)))
...
def plot_by_gene_and_tissue_and_age(gencode_id, gene_name, tissue):
    ...
    fig.update_xaxes(type='category')
    fig.update_layout(violinmode='group', template="plotly_dark",  yaxis_title="TPM",  title= "Violin plot of Gene {}({}), Tissue {} divided by age".format(gencode_id, gene_name, tissue), autosize=False, width=1000, height=1500, xaxis=dict(rangeslider=dict(
                     visible=True)))
    fig.update_yaxes(autorange = True,fixedrange = False)
    return fig
...
def plot_by_gene(gencode_id, gene_name):
    ...
    fig.update_xaxes(type='category')
    fig.update_layout(template="plotly_dark",  yaxis_title="TPM", title= "Violin plot of Gene {}({})".format(gencode_id, gene_name), autosize=False, width=1000, height=1500, xaxis=dict(rangeslider=dict(
                     visible=True)))
    return fig
...
def plot_by_gene_and_tissue(gene, gene_name, tissue):
    ...
    fig.update_layout(template="plotly_dark", yaxis_title="TPM", title= "Violin plot of Gene {}({}) and Tissue {}".format(gene, gene_name, tissue))
    return fig
...
def plot_by_gene_tissue_age_and_gender(gencode_id, gene_name, tissue):
    ...
    for i, (age, data_age) in enumerate(data_age_gender.items()):
        for j, (gender, data_age_gender) in enumerate(data_age.items()):
            ...
            idx += 1
    fig.update_xaxes(type='category')
    fig.update_layout(violinmode='group', yaxis_title = "TPM", template="plotly_dark", title= "Violin plot of Gene {}({}), tissue {} divided by Gender and Age".format(gencode_id, gene_name, tissue), autosize=False, width=1000, height=1500, xaxis=dict(rangeslider=dict(
                     visible=True)))
    # fig.update_yaxes(autorange = True,fixedrange = False)
    return fig  
...
def plot_gene_tissue_data(gene, gene_name, tissue):
    ...
    fig.update_layout(template="plotly_dark", title= "Pie charts for Gene {}({}) and Tissue {}".format(gene, gene_name, tissue), xaxis =  {                                     
